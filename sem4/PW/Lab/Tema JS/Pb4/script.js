...
window.onload = function() {
    arr.push({nume: "Pop", prenume: "Ion", varsta: 30, salariu: 8320.20});
    arr.push({nume: "Popescu", prenume: "Andrei", varsta: 45, salariu: 2700.70});
    arr.push({nume: "Iliescu", prenume: "Andrei", varsta: 27, salariu: 5080.60});
    arr.push({nume: "Runcan", prenume: "Maria", varsta: 20, salariu: 6530.10});
